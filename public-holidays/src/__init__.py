...
def reset_style(style_object):
    ...
    style_object.set_text_color(lv.color_hex(0x2D3436))
...
header_style.set_text_color(lv.color_hex(0x2D3436))
...
def fetch_and_display_public_holiday(current_date: int) -> None:
    ...
    for event in future_events:
        ...
        date_label.set_width(110)
        date_label.align(lv.ALIGN.RIGHT_MID, 0, 0)
        date_label.set_style_text_align(lv.TEXT_ALIGN.RIGHT, 0)
